...
describe('RFC8484 Resolver', function () {
    ...
    describe('resolve', function(){
        ...
        [
            ...
            {hostname: expected.A.host, rrval: 'A', result: expected.A.records, options: {dnssec: true}},
            ...
            it(`should resolve ${test.rrval || 'A'} records for ${test.hostname} given rrval: ${test.rrval} and options: ${JSON.stringify(test.options)}`, test.pending ? undefined : async function () {
